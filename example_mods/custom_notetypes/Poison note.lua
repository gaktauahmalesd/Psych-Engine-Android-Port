function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Poison note' then --Check if the note on the chart is a poison note
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'Shared/image/Poison note'); --Change texture
